...
var ctx = canvas.getContext("2d");
      ...
      // backgroundBoxes/Path
      ctx.save();
      ctx.beginPath();
      ctx.moveTo(980.0, 490.0);
      ctx.lineTo(766.0, 490.0);
      ctx.lineTo(766.0, 0.0);
      ...
      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(765.2, 490.0);
      ctx.lineTo(609.0, 490.0);
      ctx.lineTo(609.0, 258.2);
      ctx.lineTo(765.2, 258.2);
      ctx.lineTo(765.2, 490.0);
      ctx.closePath();
      ...
      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(610.0, 490.0);
      ctx.lineTo(0.0, 490.0);
      ctx.lineTo(0.0, 430.0);
      ctx.lineTo(610.0, 430.0);
      ctx.lineTo(610.0, 490.0);
      ctx.closePath();
      ctx.fill();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(609.0, 410.8);
      ctx.lineTo(0.0, 410.8);
      ctx.lineTo(0.0, 429.2);
      ctx.lineTo(609.0, 429.2);
      ctx.lineTo(609.0, 410.8);
      ctx.closePath();
      ctx.fillStyle = "rgb(149, 182, 223)";
      ctx.fill();
      ...
      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(764.0, 195.0);
      ctx.lineTo(114.0, 195.0);
      ctx.lineTo(114.0, 26.0);
      ctx.lineTo(764.0, 26.0);
      ctx.lineTo(764.0, 195.0);
      ctx.closePath();
      ctx.fillStyle = "rgb(229, 235, 246)";
      ctx.fill();

      // backgroundBoxes/Group

      // backgroundBoxes/Group/Path
      ctx.save();
      ctx.beginPath();
      ...
      ctx.lineTo(114.0, 26.0);
      ctx.closePath();
      ctx.strokeStyle = "rgb(149, 182, 223)";
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 182.0);
      ctx.lineTo(764.0, 182.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 169.0);
      ctx.lineTo(764.0, 169.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 156.0);
      ctx.lineTo(764.0, 156.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 143.0);
      ctx.lineTo(764.0, 143.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 130.0);
      ctx.lineTo(764.0, 130.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 117.0);
      ctx.lineTo(764.0, 117.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 104.0);
      ctx.lineTo(764.0, 104.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 91.0);
      ctx.lineTo(764.0, 91.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 78.0);
      ctx.lineTo(764.0, 78.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 65.0);
      ctx.lineTo(764.0, 65.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 52.0);
      ctx.lineTo(764.0, 52.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(114.0, 39.0);
      ctx.lineTo(764.0, 39.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(751.0, 26.0);
      ctx.lineTo(751.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(738.0, 26.0);
      ctx.lineTo(738.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(725.0, 26.0);
      ctx.lineTo(725.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(711.9, 26.0);
      ctx.lineTo(711.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(698.9, 26.0);
      ctx.lineTo(698.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(685.9, 26.0);
      ctx.lineTo(685.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(673.1, 26.0);
      ctx.lineTo(673.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(660.1, 26.0);
      ctx.lineTo(660.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(647.0, 26.0);
      ctx.lineTo(647.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(634.0, 26.0);
      ctx.lineTo(634.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(621.0, 26.0);
      ctx.lineTo(621.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(608.0, 26.0);
      ctx.lineTo(608.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(595.0, 26.0);
      ctx.lineTo(595.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(582.0, 26.0);
      ctx.lineTo(582.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(569.0, 26.0);
      ctx.lineTo(569.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(556.0, 26.0);
      ctx.lineTo(556.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(542.9, 26.0);
      ctx.lineTo(542.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(529.9, 26.0);
      ctx.lineTo(529.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(517.1, 26.0);
      ctx.lineTo(517.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(504.1, 26.0);
      ctx.lineTo(504.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(491.1, 26.0);
      ctx.lineTo(491.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(478.0, 26.0);
      ctx.lineTo(478.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(465.0, 26.0);
      ctx.lineTo(465.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(452.0, 26.0);
      ctx.lineTo(452.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(439.0, 26.0);
      ctx.lineTo(439.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(426.0, 26.0);
      ctx.lineTo(426.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(413.0, 26.0);
      ctx.lineTo(413.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(400.0, 26.0);
      ctx.lineTo(400.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(386.9, 26.0);
      ctx.lineTo(386.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(373.9, 26.0);
      ctx.lineTo(373.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(360.9, 26.0);
      ctx.lineTo(360.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(348.1, 26.0);
      ctx.lineTo(348.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(335.1, 26.0);
      ctx.lineTo(335.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(322.0, 26.0);
      ctx.lineTo(322.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(309.0, 26.0);
      ctx.lineTo(309.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(296.0, 26.0);
      ctx.lineTo(296.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(283.0, 26.0);
      ctx.lineTo(283.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(270.0, 26.0);
      ctx.lineTo(270.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(257.0, 26.0);
      ctx.lineTo(257.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(244.0, 26.0);
      ctx.lineTo(244.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(231.0, 26.0);
      ctx.lineTo(231.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(217.9, 26.0);
      ctx.lineTo(217.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(204.9, 26.0);
      ctx.lineTo(204.9, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(192.1, 26.0);
      ctx.lineTo(192.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(179.1, 26.0);
      ctx.lineTo(179.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(166.1, 26.0);
      ctx.lineTo(166.1, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(153.0, 26.0);
      ctx.lineTo(153.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(140.0, 26.0);
      ctx.lineTo(140.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Group/Path
      ctx.beginPath();
      ctx.moveTo(127.0, 26.0);
      ctx.lineTo(127.0, 195.0);
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.restore();
      ctx.beginPath();
      ctx.moveTo(114.0, 116.0);
      ctx.lineTo(764.0, 116.0);
      ctx.lineWidth = 2.0;
      ctx.strokeStyle = "rgb(83, 111, 147)";
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(105.0, 182.0);
      ctx.lineTo(764.0, 182.0);
      ctx.strokeStyle = "rgb(149, 182, 223)";
      ctx.stroke();
      ...
      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(105.0, 52.0);
      ctx.lineTo(764.0, 52.0);
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(113.0, 25.0);
      ctx.lineTo(113.0, 203.0);
      ctx.strokeStyle = "rgb(83, 111, 147)";
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(634.0, 25.0);
      ctx.lineTo(634.0, 203.0);
      ctx.strokeStyle = "rgb(149, 182, 223)";
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(244.0, 25.0);
      ctx.lineTo(244.0, 203.0);
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(504.0, 25.0);
      ctx.lineTo(504.0, 203.0);
      ctx.stroke();

      // backgroundBoxes/Path
      ctx.beginPath();
      ctx.moveTo(373.0, 25.0);
      ctx.lineTo(373.0, 203.0);
      ctx.stroke();
      ctx.restore();

      // backgroundText/Frequency
      ctx.save();
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(34, 30, 31)";
      ctx.fillText("Frequency", 626.0, 290.0);

      // backgroundText/Wavelength
      ctx.fillText("Wavelength", 625.0, 366.3);

      // backgroundText/Amplitude
      ctx.fillText("Amplitude", 627.0, 448.0);

      // backgroundText/Octave
      ctx.fillText("Octave", 349.0, 449.3);

      // backgroundText/Score
      ctx.fillText("Score", 475.0, 449.3);

      // backgroundText/Hz
      ctx.font = "18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("Hz", 732.0, 318.0);

      // backgroundText/m
      ctx.fillText("m", 731.0, 393.7);

      // backgroundText/Pa
      ctx.fillText("Pa", 731.0, 477.0);

      // backgroundText/
      ctx.fillText("%", 581.0, 476.0);

      // backgroundText/VerticalScale
      ctx.font = "Bold 18.0px 'Arial'";
//      ctx.fillText("Amplitude", 10.0, 50.0);
      ctx.fillText("Vertical", 10.0, 45.0);
      ctx.fillText("scale",    10.0, 60.0);

      // backgroundText/Distance
      ctx.font = "18.0px 'Arial'";
      //ctx.fillText("Distance", 17.0, 161.0);

      // backgroundText/Time
      //ctx.fillText("Time", 17.0, 230.0);
      ctx.restore();
      ...
      // timeBackground/Time s
      ctx.save();
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillText("Time (s)", 691.0, 225.0);
      ctx.restore();
      ...
      // data/4
      ctx.save();
      ctx.font = "18.0px 'Times New Roman'";
      ctx.fillText("4", 418.5, 474.8);
      ctx.restore();
      ...
      // title/Sound waves and the keyboard
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(45, 48, 144)";
      ctx.fillText("Sound waves and the keyboard", 69.3, 19.5);
      ...
      // title/Group/Group/Compound Path
      ctx.save();
      ctx.beginPath();

      // title/Group/Group/Compound Path/Path
      ctx.moveTo(9.7, 21.1);
      ...
      // title/Group/Compound Path
      ctx.beginPath();

      // title/Group/Compound Path/Path
      ctx.moveTo(33.5, 3.0);
      ctx.lineTo(33.5, 4.7);
      ctx.lineTo(30.5, 4.7);
      ctx.lineTo(30.3, 8.1);
