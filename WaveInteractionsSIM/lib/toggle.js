...
this.down_stoped_LF=function(){
      ...
      gradient.addColorStop(0.00, "rgb(200, 239 , 221)");
      gradient.addColorStop(0.50, "rgb(110, 156 , 141)");
      gradient.addColorStop(0.98, "rgb(19,  73 , 60)");
      ctx.fillStyle = gradient;
      ctx.fill();
...
this.over_stoped_LF=function(){
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(13.7, 19.7, 36.3, 30.3);
      gradient.addColorStop(0.00, "rgb(190, 244 , 231)");
      gradient.addColorStop(0.50, "rgb(95, 187 , 160)");
      gradient.addColorStop(0.98, "rgb(0, 129 , 88)");
      ctx.fillStyle = gradient;
      ctx.fill();
      ctx.lineWidth = 1.5;
      ctx.lineJoin = "miter";
