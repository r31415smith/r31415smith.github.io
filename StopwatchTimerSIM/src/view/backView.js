...
var gradient;
      ...
      ctx.beginPath();
      ctx.moveTo(0.0, 25.0);
      ctx.lineTo(275.0, 25.0);
      ctx.lineTo(275.0, 356.0);
      ctx.lineTo(0.0, 356.0);
      ctx.lineTo(0.0, 25.0);
      ctx.closePath();
      ...
      // background/Path
      ctx.beginPath();
      ctx.moveTo(769.0, 356.0);
      ctx.lineTo(525.0, 356.0);
      ctx.lineTo(525.0, 25.0);
      ctx.lineTo(769.0, 25.0);
      ctx.lineTo(769.0, 356.0);
      ctx.closePath();
      ctx.fill();

      // background/Path
      ctx.beginPath();
      ctx.moveTo(525.0, 356.0);
      ctx.lineTo(275.0, 356.0);
      ctx.lineTo(275.0, 25.0);
      ctx.lineTo(525.0, 25.0);
      ctx.lineTo(525.0, 356.0);
      ctx.closePath();
      ctx.fillStyle = "rgb(229, 236, 246)";
      ctx.fill();

      // background/s
      ctx.font = "18.0px 'Arial'";
      ctx.fillStyle = "rgb(34, 30, 31)";
      ctx.fillText("s", 175.4, 182.4);

      // background/Timer
      ctx.font = "Bold 36.0px 'Arial'";
      ctx.fillStyle = "rgb(26, 116, 186)";
      ctx.fillText("Timer", 346.1, 62.7);

      // background/Stopwatch
      ctx.fillText("Stopwatch", 45.5, 62.7);

      // background/h
      ctx.font = "18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("h", 75.5, 314.8);

      // background/m
      ctx.fillText("m", 145.5, 314.8);

      // background/s
      ctx.fillText("s", 245.5, 314.8);

      // background/Sound every
      ctx.fillText("Sound every", 289.0, 104.8);

      // background/s
      ctx.fillText("s", 487.0, 104.8);

      // background/s
      ctx.fillText("s", 450.5, 215.8);

      // background/Path
      ctx.beginPath();
      ctx.moveTo(275.0, 25.0);
      ctx.lineTo(275.0, 356.0);
      ctx.lineWidth = 3.0;
      ctx.strokeStyle = "rgb(26, 116, 186)";
      ctx.stroke();

      // background/Path
      ctx.beginPath();
      ctx.moveTo(525.0, 25.0);
      ctx.lineTo(525.0, 356.0);
      ctx.stroke();

      // background/Countdowntimer
      ctx.font = "Bold 36.0px 'Arial'";
      ctx.fillStyle = "rgb(26, 116, 186)";
      ctx.fillText("Countdown", 546.0, 62.7);
      ctx.fillText("timer", 601.0, 105.9);

      // background/Start at
      ctx.font = "18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("Start at", 563.2, 164.8);

      // background/s
      ctx.fillText("s", 716.2, 164.8);

      // background/Image
      ctx.drawImage(document.getElementById("image1"), 43.2, 82.9);

      // background/Image
      ctx.drawImage(document.getElementById("image2"), 544.3, 252.9);
      ...
      // background/Stopwatch and timer utility
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(45, 48, 144)";
      ctx.fillText("Stopwatch and timer utility", 69.3, 19.5);
      ...
      ctx.restore();
      ctx.beginPath();
      ctx.moveTo(384.8, 151.7);
      ctx.bezierCurveTo(384.8, 141.3, 376.4, 132.9, 366.0, 132.9);
      ctx.bezierCurveTo(355.6, 132.9, 347.2, 141.3, 347.2, 151.7);
      ctx.bezierCurveTo(347.2, 162.0, 355.6, 170.4, 366.0, 170.4);
      ctx.bezierCurveTo(376.4, 170.4, 384.8, 162.0, 384.8, 151.7);
      ctx.closePath();
      ctx.fillStyle = "rgb(56, 180, 73)";
      ctx.fill();

      // background/Compound Path
      ctx.beginPath();

      // background/Compound Path/Path
      ctx.moveTo(365.9, 172.0);
      ctx.bezierCurveTo(354.7, 172.0, 345.6, 163.0, 345.6, 151.8);
      ctx.bezierCurveTo(345.6, 140.6, 354.7, 131.5, 365.9, 131.5);
      ctx.bezierCurveTo(377.0, 131.5, 386.1, 140.6, 386.1, 151.8);
      ctx.bezierCurveTo(386.1, 163.0, 377.0, 172.0, 365.9, 172.0);
      ctx.closePath();

      // background/Compound Path/Path
      ctx.moveTo(365.9, 134.5);
      ctx.bezierCurveTo(356.4, 134.5, 348.6, 142.3, 348.6, 151.8);
      ctx.bezierCurveTo(348.6, 161.3, 356.4, 169.0, 365.9, 169.0);
      ctx.bezierCurveTo(375.4, 169.0, 383.1, 161.3, 383.1, 151.8);
      ctx.bezierCurveTo(383.1, 142.3, 375.4, 134.5, 365.9, 134.5);
      ctx.closePath();
      gradient = ctx.createRadialGradient(366.0, 151.9, 0.0, 366.0, 151.9, 20.2);
      gradient.addColorStop(0.89, "rgb(48, 48, 48)");
      gradient.addColorStop(0.95, "rgb(135, 135, 135)");
      gradient.addColorStop(1.00, "rgb(229, 229, 229)");
      ctx.fillStyle = gradient;
      ctx.fill();
      ctx.lineWidth = 1.0;
      ctx.strokeStyle = "rgb(187, 189, 191)";
      ctx.stroke();

      // background/Path
      ctx.beginPath();
      ctx.moveTo(441.6, 151.7);
      ctx.bezierCurveTo(441.6, 141.3, 433.2, 132.9, 422.9, 132.9);
      ctx.bezierCurveTo(412.5, 132.9, 404.1, 141.3, 404.1, 151.7);
      ctx.bezierCurveTo(404.1, 162.0, 412.5, 170.4, 422.9, 170.4);
      ctx.bezierCurveTo(433.2, 170.4, 441.6, 162.0, 441.6, 151.7);
      ctx.closePath();
      ctx.fillStyle = "rgb(189, 29, 44)";
      ctx.fill();
      ctx.strokeStyle = "rgb(208, 210, 211)";
      ctx.stroke();
      ...
      // background/Compound Path/Path
      ctx.moveTo(422.8, 172.0);
      ctx.bezierCurveTo(411.6, 172.0, 402.5, 163.0, 402.5, 151.8);
      ctx.bezierCurveTo(402.5, 140.6, 411.6, 131.5, 422.8, 131.5);
      ctx.bezierCurveTo(433.9, 131.5, 443.0, 140.6, 443.0, 151.8);
      ctx.bezierCurveTo(443.0, 163.0, 433.9, 172.0, 422.8, 172.0);
      ctx.closePath();

      // background/Compound Path/Path
      ctx.moveTo(422.8, 134.5);
      ctx.bezierCurveTo(413.2, 134.5, 405.5, 142.3, 405.5, 151.8);
      ctx.bezierCurveTo(405.5, 161.3, 413.2, 169.0, 422.8, 169.0);
      ctx.bezierCurveTo(432.3, 169.0, 440.0, 161.3, 440.0, 151.8);
      ctx.bezierCurveTo(440.0, 142.3, 432.3, 134.5, 422.8, 134.5);
      ctx.closePath();
      gradient = ctx.createRadialGradient(422.9, 151.9, 0.0, 422.9, 151.9, 20.2);
      gradient.addColorStop(0.89, "rgb(48, 48, 48)");
      gradient.addColorStop(0.95, "rgb(135, 135, 135)");
      gradient.addColorStop(1.00, "rgb(229, 229, 229)");
      ctx.fillStyle = gradient;
