function backView(canvas){
    ...
    function draw(ctx) {
      ...
      // title/Speed wavelength and frequency of a wave calculator
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(45, 48, 144)";
      ctx.fillText("Speed, wavelength, and frequency of a wave", 60.8, 19.3);
      ctx.restore();
      ...
      ctx.moveTo(238.2, 269.7);
      ctx.lineTo(238.2, 265.9);
      ctx.lineTo(265.0, 265.9);
      ctx.lineTo(265.0, 269.7);
      ctx.lineTo(238.2, 269.7);
      ctx.closePath();

      // equalsButton/Group/Group/Compound Path/Path
      ctx.moveTo(238.2, 276.2);
      ctx.lineTo(238.2, 272.4);
      ctx.lineTo(265.0, 272.4);
      ctx.lineTo(265.0, 276.2);
      ctx.lineTo(238.2, 276.2);
      ctx.closePath();
      ...
      // equationTNR60ptItalics/Type
      ctx.save();

      // equationTNR60ptItalics/Group

      // equationTNR60ptItalics/Group/Compound Path
      ctx.save();
      ctx.beginPath();

      // equationTNR60ptItalics/Group/Compound Path/Path
      ctx.moveTo(455.5, 269.9);
      ctx.lineTo(460.0, 274.5);
      ctx.lineTo(464.5, 269.9);
      ctx.lineTo(465.4, 270.8);
      ctx.lineTo(460.9, 275.4);
      ctx.lineTo(465.4, 280.0);
      ctx.lineTo(464.5, 280.9);
      ctx.lineTo(460.0, 276.3);
      ctx.lineTo(455.5, 280.9);
      ctx.lineTo(454.6, 280.0);
      ctx.lineTo(459.1, 275.4);
      ctx.lineTo(454.6, 270.8);
      ctx.lineTo(455.5, 269.9);
      ctx.closePath();
      ctx.fill();
      ...
      // equationTNR60ptItalics/Group/Compound Path/Path
      ctx.moveTo(343.1, 181.2);
      ctx.bezierCurveTo(343.0, 179.3, 343.1, 177.3, 343.2, 174.9);
      ctx.lineTo(343.0, 174.9);
      ctx.bezierCurveTo(341.9, 176.9, 340.4, 179.1, 339.1, 181.1);
      ctx.lineTo(327.5, 197.9);
      ctx.lineTo(322.0, 197.9);
      ctx.lineTo(341.5, 171.0);
      ctx.bezierCurveTo(341.9, 170.3, 342.1, 169.9, 342.2, 169.6);
      ctx.bezierCurveTo(342.3, 169.2, 342.4, 168.8, 342.4, 168.0);
      ctx.bezierCurveTo(342.2, 162.9, 341.4, 158.9, 337.9, 158.9);
      ctx.bezierCurveTo(337.6, 158.9, 337.2, 158.9, 336.8, 159.0);
      ctx.lineTo(338.7, 154.9);
      ctx.bezierCurveTo(339.2, 154.7, 340.1, 154.7, 340.8, 154.7);
      ctx.bezierCurveTo(346.5, 154.7, 347.3, 160.1, 347.7, 168.3);
      ctx.lineTo(349.0, 197.9);
      ctx.lineTo(343.4, 197.9);
      ctx.lineTo(343.1, 181.2);
      ctx.closePath();
      ctx.fill();

      // equationTNR60ptItalics/
      ctx.restore();
      ctx.font = " 60.0px 'SymbolMT'";
      ctx.save();
      ctx.transform(1.000, 0.000, 0.000, 1.000, 233.8, 197.2);
      ctx.fillText("=", 0, 0);
      ctx.restore();

      // equationTNR60ptItalics/v
      ctx.font = "Italic 60.0px 'Times New Roman'";
      ctx.save();
      ctx.transform(1.000, 0.000, 0.000, 1.000, 192.3, 197.3);
      ctx.fillText("v", 0, 0);
      ctx.restore();

      // equationTNR60ptItalics/f
      ctx.save();
      ctx.transform(1.000, 0.000, 0.000, 1.000, 291.7, 198.0);
      ctx.fillText("f", 0, 0);
      ctx.restore();
      ctx.restore();
      ...
      ctx.fillText("f", 381.6, 313.4);

      // quantitiesAndUnits/Group

      // quantitiesAndUnits/Group/Compound Path
      ctx.save();
      ctx.beginPath();

      // quantitiesAndUnits/Group/Compound Path/Path
      ctx.moveTo(531.9, 313.4);
      ctx.lineTo(530.0, 313.4);
      ctx.lineTo(536.4, 304.2);
      ctx.lineTo(536.5, 302.4);
      ctx.bezierCurveTo(536.5, 301.4, 536.4, 300.7, 536.1, 300.4);
      ctx.bezierCurveTo(535.9, 300.1, 535.7, 300.0, 535.3, 300.0);
      ctx.bezierCurveTo(534.7, 300.0, 534.3, 300.5, 534.1, 301.5);
      ctx.lineTo(533.8, 301.5);
      ctx.bezierCurveTo(533.8, 300.7, 534.1, 300.1, 534.4, 299.5);
      ctx.bezierCurveTo(534.8, 299.0, 535.2, 298.8, 535.7, 298.8);
      ctx.bezierCurveTo(536.1, 298.8, 536.4, 299.0, 536.7, 299.3);
      ctx.bezierCurveTo(536.9, 299.7, 537.0, 300.3, 537.0, 301.2);
      ctx.bezierCurveTo(537.0, 301.3, 537.0, 301.4, 537.0, 301.6);
      ctx.lineTo(536.7, 310.2);
      ctx.bezierCurveTo(536.7, 310.3, 536.7, 310.4, 536.7, 310.5);
      ctx.bezierCurveTo(536.7, 311.7, 537.0, 312.3, 537.8, 312.3);
      ctx.bezierCurveTo(538.4, 312.3, 538.8, 311.9, 538.9, 311.1);
      ctx.lineTo(539.3, 311.1);
      ctx.bezierCurveTo(539.2, 311.8, 539.1, 312.3, 538.8, 312.8);
      ctx.bezierCurveTo(538.5, 313.2, 538.1, 313.5, 537.5, 313.5);
      ctx.bezierCurveTo(536.6, 313.5, 536.1, 312.9, 536.1, 311.7);
      ctx.bezierCurveTo(536.1, 311.6, 536.2, 311.4, 536.2, 311.0);
      ctx.lineTo(536.3, 306.9);
      ctx.lineTo(531.9, 313.4);
      ctx.closePath();
      ctx.fill();
      ...
      ctx.fillText("(hertz, Hz)", 343.0, 336.2);

      // quantitiesAndUnits/meter m
      ctx.fillText("(meter, m)", 494.0, 336.2);

      // Solve for variable over pull-down menu
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("Solve for:", 500, 170);

      // quantitiesAndUnits/v
      ctx.font = "Italic 21.0px 'Times New Roman'";
      ctx.fillText("v", 99.0, 313.4);

      // quantitiesAndUnits/meters per second ms
      ctx.font = "18.0px 'Arial'";
      ctx.fillText("(meters per second, m/s)", 5.0, 336.2);

      // quantitiesAndUnits/Frequency
      ctx.font = "24.0px 'Arial'";
      ctx.fillStyle = "rgb(26, 116, 186)";
      ctx.fillText("Frequency", 328.3, 248.8);

      // quantitiesAndUnits/Wavelength
      ctx.fillText("Wavelength", 472.1, 246.9);

      // quantitiesAndUnits/Speed of wave
      ctx.fillText("Speed of wave", 25.6, 248.8);
      ctx.restore();

      // waveAcrossTop/Group
      ctx.save();

      // waveAcrossTop/Group/Path
      ctx.save();
      ctx.beginPath();
      ctx.moveTo(125.0, 100.0);
      ctx.lineTo(25.0, 100.0);
      ctx.lineTo(25.0, 120.0);
      ctx.lineTo(125.0, 120.0);
      ctx.lineTo(125.0, 100.0);
      ctx.closePath();
      ctx.fillStyle = "rgb(255, 206, 134)";
      ctx.fill();
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(45.0, 100.1);
      ctx.lineTo(45.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(85.0, 100.1);
      ctx.lineTo(85.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(65.0, 100.1);
      ctx.lineTo(65.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(105.0, 100.1);
      ctx.lineTo(105.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(35.0, 100.1);
      ctx.lineTo(35.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(75.0, 100.1);
      ctx.lineTo(75.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(55.0, 100.1);
      ctx.lineTo(55.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(95.0, 100.1);
      ctx.lineTo(95.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(115.0, 100.1);
      ctx.lineTo(115.0, 110.1);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(50.0, 100.3);
      ctx.lineTo(50.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(90.0, 100.3);
      ctx.lineTo(90.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(70.0, 100.3);
      ctx.lineTo(70.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(110.0, 100.3);
      ctx.lineTo(110.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(40.0, 100.3);
      ctx.lineTo(40.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(80.0, 100.3);
      ctx.lineTo(80.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(60.0, 100.3);
      ctx.lineTo(60.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(100.0, 100.3);
      ctx.lineTo(100.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(120.0, 100.3);
      ctx.lineTo(120.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/Group/Path
      ctx.beginPath();
      ctx.moveTo(30.0, 100.3);
      ctx.lineTo(30.0, 105.3);
      ctx.stroke();

      // waveAcrossTop/1 meter
      ctx.restore();
      ctx.font = "12.0px 'Arial'";
      ctx.fillText("1 meter", 54.7, 132.0);
      ctx.restore();
