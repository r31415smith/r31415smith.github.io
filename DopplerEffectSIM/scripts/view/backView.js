...
var ctx = canvas.getContext("2d");
 ...
 // background/Path
      ctx.save();
      ctx.beginPath();
      ctx.moveTo(752.0, 478.0);
      ctx.lineTo(0.0, 478.0);
      ctx.lineTo(0.0, 418.0);
      ctx.lineTo(752.0, 418.0);
      ctx.lineTo(752.0, 478.0);
      ctx.closePath();
      ...
      // background/Path
      ctx.beginPath();
      ctx.moveTo(980.0, 478.0);
      ctx.lineTo(752.0, 478.0);
      ctx.lineTo(752.0, 25.0);
      ctx.lineTo(980.0, 25.0);
      ctx.lineTo(980.0, 478.0);
      ctx.closePath();
      ctx.fillStyle = "rgb(188, 207, 235)";
      ctx.fill();

      // background/Observer velocity
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(34, 30, 31)";
      ctx.fillText("Observer velocity", 394.5, 471.0);

      // background/Source velocity
      ctx.fillText("Source velocity", 213.5, 471.0);

      // background/ms
      ctx.font = "18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("m/s", 508.2, 445.0);

      // background/ms
      ctx.fillText("m/s", 316.8, 444.0);

      // background/Path
      ctx.beginPath();
      ctx.moveTo(751.0, 116.0);
      ctx.lineTo(1.0, 116.0);
      ctx.lineTo(1.0, 26.0);
      ctx.lineTo(751.0, 26.0);
      ctx.lineTo(751.0, 116.0);
      ctx.closePath();
      ...
      // background/Path
      ctx.beginPath();
      ctx.moveTo(751.0, 416.8);
      ctx.lineTo(1.0, 416.8);
      ctx.lineTo(1.0, 116.8);
      ctx.lineTo(751.0, 116.8);
      ctx.lineTo(751.0, 416.8);
      ctx.closePath();
      ctx.fillStyle = "rgb(229, 235, 246)";
      ctx.fill();
      ctx.stroke();

      // background/Source Frequency
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("Source Frequency", 13.4, 471.0);

      // background/Hz
      ctx.font = "18.0px 'Arial'";
      ctx.fillText("Hz", 140.4, 444.0);

      // background/f
      ctx.font = "Italic 21.0px 'Times New Roman'";
      ctx.fillText("f", 13.2, 441.8);

      // background/0
      ctx.font = "15.8px 'Times New Roman'";
      ctx.fillText("0", 19.4, 449.0);

      // background/Relative velocity
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(34, 30, 31)";
      ctx.fillText("Relative velocity", 584.5, 471.0);

      // background/ms
      ctx.font = "18.0px 'Arial'";
      ctx.fillStyle = "rgb(0, 0, 0)";
      ctx.fillText("m/s", 698.2, 445.0);
      ctx.restore();
      ...
      // logos/Doppler effect simulation
      ctx.font = "Bold 18.0px 'Arial'";
      ctx.fillStyle = "rgb(45, 48, 144)";
      ctx.fillText("Doppler effect simulation", 69.3, 19.5);
      ...
      // logos/Group/Group/Compound Path
      ctx.save();
      ctx.beginPath();

      // logos/Group/Group/Compound Path/Path
      ctx.moveTo(9.7, 21.1);
      ...
      // logos/Group/Compound Path
      ctx.beginPath();

      // logos/Group/Compound Path/Path
      ctx.moveTo(33.5, 3.0);
      ctx.lineTo(33.5, 4.7);
      ctx.lineTo(30.5, 4.7);
      ctx.lineTo(30.3, 8.1);
