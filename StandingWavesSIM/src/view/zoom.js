...
*/
function zoom(left,top,width,height){
    
this.background = document.createElement("canvas");
this.slideElement = document.createElement("canvas");
this.htmlElement = document.createElement("div");

this.plusElement = document.createElement("canvas");
this.minusElement = document.createElement("canvas");
...
this.htmlElement.appendChild(this.plusElement);
this.htmlElement.appendChild(this.minusElement);
...
this.minusElement.setAttribute("width",60);
this.minusElement.setAttribute("height",60);
this.minusElement.style.position = "absolute";
this.minusElement.style.top =  "-10px";
this.minusElement.style.left = "-40px";
//this.minusElement.style.backgroundColor = "#FFcccc";


this.plusElement.setAttribute("width",60);
this.plusElement.setAttribute("height",60);
this.plusElement.style.position = "absolute";
this.plusElement.style.top =  "-10px";
this.plusElement.style.left = (this.width-22)+"px";
//this.plusElement.style.backgroundColor = "#FFcccc";
...
c.slideFunction = function(e){
    ...
    if(c.slidePosition<25)
    {
        c.slidePosition=25;
    }
    if(c.slidePosition>c.width-35)
    {
        c.slidePosition=c.width-35;
    }
    c.drawSlider();

}

c.slideElement.addEventListener("mousedown",function(e){
    c.slideHandle = c.slideFunction;
    c.userFuncHandle=c.userFunction;
});

c.slideElement.addEventListener("mousemove",function(e){
    c.slideHandle(e);
    c.userFuncHandle(c.slidePosition);
});
c.slideElement.addEventListener("mouseout",function(e){
    c.slideHandle = null;
    c.userFuncHandle=null;
});
c.slideElement.addEventListener("mouseup",function(e){
    c.slideHandle = null;
    c.userFuncHandle=null;
});

this.plusElement.addEventListener("mousedown",function(e){
    c.slidePosition=c.slidePosition+1;
    if(c.slidePosition<25)
    {
        c.slidePosition=25;
    }
...
this.minusElement.addEventListener("mousedown",function(e){
...
this.plusElement.addEventListener("touchstart",function(e){
    c.slidePosition=c.slidePosition+1;
    if(c.slidePosition<25)
    {
        c.slidePosition=25;
...
this.minusElement.addEventListener("touchstart",function(e){
...
this.plusElement.attachEvent("onmousedown",function(e){
    c.slidePosition=c.slidePosition+1;
    if(c.slidePosition<25)
    {
        c.slidePosition=25;
...
this.minusElement.attachEvent("onmousedown",function(e){
